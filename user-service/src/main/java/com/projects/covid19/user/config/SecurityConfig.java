...
import com.projects.covid19.user.components.CustomRestAccessDenied;
import com.projects.covid19.user.components.CustomRestAuthenticationEntryPoint;
import com.projects.covid19.user.filters.JwtAuthenticationFilter;
    ...
    @Override
  	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		.authorizeRequests()
			...
			.antMatchers(HttpMethod.GET, "/api/auth/ping").permitAll()  
